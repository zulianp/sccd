...
typedef struct SCCD {
    ...
    void find()
    {
        ...
        lean_sort_along_axis(
            nfaces, sort_axis, faabb, fidx.data(), scratch.data());
        lean_sort_along_axis(
            nnodes, sort_axis, vaabb, vidx.data(), scratch.data());
        lean_sort_along_axis(
            nedges, sort_axis, eaabb, eidx.data(), scratch.data());
        ...
        lean_collect_self_overlaps<2>(
            sort_axis, nedges, eaabb, eidx.data(), 2, soaedges, ccdptr.data(),
            e0_overlap.data(), e1_overlap.data());
